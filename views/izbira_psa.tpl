...
<html lang="en">
	  ...
	  <tbody>
		  ...
		  <td>
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="notranjost">
				<label class="btn btn-secondary active">
					<input type="radio" name="notranjost" id="notranjost1" value="notranjost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="notranjost" id="notranjost2" value="notranjost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="notranjost" id="notranjost3" value="notranjost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		  ...
		  <th scope="row">Nimam izkušenj s psi</th>
		   <td>
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="izkusnje">
				<label class="btn btn-secondary active">
					<input type="radio" name="izkusnje" id="izkusnje1" value="izkusnje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="izkusnje" id="izkusnje2" value="izkusnje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="izkusnje" id="izkusnje3" value="izkusnje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
		 ...
		 <td>
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="obcutljivost">
				<label class="btn btn-secondary active">
					<input type="radio" name="obcutljivost" id="obcutljivost1" value="obcutljivost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="obcutljivost" id="obcutljivost2" value="obcutljivost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="obcutljivost" id="obcutljivost3" value="obcutljivost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="samota">
				<label class="btn btn-secondary active">
					<input type="radio" name="samota" id="samota1" value="samota1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="samota" id="samota2" value="samota2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="samota" id="samota3" value="samota3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="hladno">
				<label class="btn btn-secondary active">
					<input type="radio" name="hladno" id="hladno1" value="hladno1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="hladno" id="hladno2" value="hladno2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="hladno" id="hladno3" value="hladno3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="toplo">
				<label class="btn btn-secondary active">
					<input type="radio" name="toplo" id="toplo1" value="toplo1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="toplo" id="toplo2" value="toplo2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="toplo" id="toplo3" value="toplo3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
	  ...
	  <tbody>    
		<tr>
		  ...
		  <td>
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="druzina">
				<label class="btn btn-secondary active">
					<input type="radio" name="druzina" id="druzina1" value="druzina1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="druzina" id="druzina2" value="druzina2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="druzina" id="druzina3" value="druzina3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="otroci">
				<label class="btn btn-secondary active">
					<input type="radio" name="otroci" id="otroci1" value="otroci1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="otroci" id="otroci2" value="otroci2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="otroci" id="otroci3" value="otroci3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="drugi_psi">
				<label class="btn btn-secondary active">
					<input type="radio" name="drugi_psi" id="drugi_psi1" value="drugi_psi1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="drugi_psi" id="drugi_psi2" value="drugi_psi2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="drugi_psi" id="drugi_psi3" value="drugi_psi3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="tujci">
				<label class="btn btn-secondary active">
					<input type="radio" name="tujci" id="tujci1" value="tujci1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="tujci" id="tujci2" value="tujci2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="tujci" id="tujci3" value="tujci3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
	...
	<div style="margin-right:100px; margin-left:100px;">	<table class="table">
	  <thead class="thead-light">
		<tr>
	  ...
	  <tbody>    
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="dlaka">
				<label class="btn btn-secondary active">
					<input type="radio" name="dlaka" id="dlaka1" value="dlaka1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="dlaka" id="dlaka2" value="dlaka2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="dlaka" id="dlaka3" value="dlaka3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="slinjenje">
				<label class="btn btn-secondary active">
					<input type="radio" name="slinjenje" id="slinjenje1" value="slinjenje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="slinjenje" id="slinjenje2" value="slinjenje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="slinjenje" id="slinjenje3" value="slinjenje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="dlaka_skrb">
				<label class="btn btn-secondary active">
					<input type="radio" name="dlaka_skrb" id="dlaka_skrb1" value="dlaka_skrb1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="dlaka_skrb" id="dlaka_skrb2" value="dlaka_skrb2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="dlaka_skrb" id="dlaka_skrb3" value="dlaka_skrb3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="zdravje">
				<label class="btn btn-secondary active">
					<input type="radio" name="zdravje" id="zdravje1" value="zdravje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="zdravje" id="zdravje2" value="zdravje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="zdravje" id="zdravje3" value="zdravje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="debelost">
				<label class="btn btn-secondary active">
					<input type="radio" name="debelost" id="debelost1" value="debelost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="debelost" id="debelost2" value="debelost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="debelost" id="debelost3" value="debelost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="velikost">
				<label class="btn btn-secondary active">
					<input type="radio" name="velikost" id="velikost1" value="velikost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="velikost" id="velikost2" value="velikost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="velikost" id="velikost3" value="velikost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
	  ...
	  <thead class="thead-light">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="ucljivost">
				<label class="btn btn-secondary active">
					<input type="radio" name="ucljivost" id="ucljivost1" value="ucljivost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="ucljivost" id="ucljivost2" value="ucljivost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="ucljivost" id="ucljivost3" value="ucljivost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="inteligenca">
				<label class="btn btn-secondary active">
					<input type="radio" name="inteligenca" id="inteligenca1" value="inteligenca1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="inteligenca" id="inteligenca2" value="inteligenca2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="inteligenca" id="inteligenca3" value="inteligenca3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="grizenje">
				<label class="btn btn-secondary active">
					<input type="radio" name="grizenje" id="grizenje1" value="grizenje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="grizenje" id="grizenje2" value="grizenje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="grizenje" id="grizenje3" value="grizenje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="lovski_nagon">
				<label class="btn btn-secondary active">
					<input type="radio" name="lovski_nagon" id="lovski_nagon1" value="lovski_nagon1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="lovski_nagon" id="lovski_nagon2" value="lovski_nagon2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="lovski_nagon" id="lovski_nagon3" value="lovski_nagon3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="lajanje">
				<label class="btn btn-secondary active">
					<input type="radio" name="lajanje" id="lajanje1" value="lajanje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="lajanje" id="lajanje2" value="lajanje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="lajanje" id="lajanje3" value="lajanje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="potepanje">
				<label class="btn btn-secondary active">
					<input type="radio" name="potepanje" id="potepanje1" value="potepanje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="potepanje" id="potepanje2" value="potepanje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="potepanje" id="potepanje3" value="potepanje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="energicnost">
				<label class="btn btn-secondary active">
					<input type="radio" name="energicnost" id="energicnost1" value="energicnost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="energicnost" id="energicnost2" value="energicnost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="energicnost" id="energicnost3" value="energicnost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="utrujenost">
				<label class="btn btn-secondary active">
					<input type="radio" name="utrujenost" id="utrujenost1" value="utrujenost1"  autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="utrujenost" id="utrujenost2" value="utrujenost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="utrujenost" id="utrujenost3" value="utrujenost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="gibanje">
				<label class="btn btn-secondary active">
					<input type="radio" name="gibanje" id="gibanje1" value="gibanje1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="gibanje" id="gibanje2" value="gibanje2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="gibanje" id="gibanje3" value="gibanje3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
		...
		<tr>
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons" name="igrivost">
				<label class="btn btn-secondary active">
					<input type="radio" name="igrivost" id="igrivost1" value="igrivost1" autocomplete="off" required> 1
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="igrivost" id="igrivost2" value="igrivost2" autocomplete="off"> 2
				</label>
				<label class="btn btn-secondary">
					<input type="radio" name="igrivost" id="igrivost3" value="igrivost3" autocomplete="off"> 3
				</label>
				<label class="btn btn-secondary">
